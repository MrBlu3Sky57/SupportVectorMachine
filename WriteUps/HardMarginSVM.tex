...
\begin{align*}
    ...
    &= \frac{1}{2}(\displaystyle \sum_{i=1}^{n} \lambda_iy_ix_i)^T(\displaystyle \sum_{j=1}^{n} \lambda_jy_jx_j) -  \sum_{i=1}^{n} y_i((\sum_{j=1}^{n} \lambda_jy_ix_j)^Tx_i) + \sum_{i=1}^{n} \lambda_i +  b\sum_{i=1}^{n} y_i \\
    &\text{We can omit the term not containing a $\lambda$:} \\
    &= \displaystyle \sum_{i = 1}^n \lambda_i - \frac{1}{2} \sum_{i = 1}^n \sum_{j = 1}^n y_iy_j\lambda_i\lambda_jx_ix_j^T
\end{align*}
